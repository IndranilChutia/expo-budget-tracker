    ...
    function renderIncomingExpenses() {
        ...
        const renderItem = ({ item, index }) => (
            <View style={{
                ...
                >
                    <Text style={{ color: COLORS.white, ...FONTS.body3 }}>CONFIRM {item.total.toFixed(2)} INR</Text>
                </View>
            </View>
        )
        ...
        const renderItem = ({ item }) => (
            ...
            >
                ...
                <View style={{ justifyContent: 'center' }}>
                    <Text style={{ color: (selectedCategory && selectedCategory.name == item.name) ? COLORS.white : COLORS.primary, ...FONTS.h3 }}>{item.y} INR - {item.label}</Text>
                </View>
            </TouchableOpacity>
        )
